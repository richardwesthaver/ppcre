;;; convert.lisp --- IR Conversion

;; Here the parse tree is converted into its internal representation using
;; REGEX objects. At the same time some optimizations are already applied.
